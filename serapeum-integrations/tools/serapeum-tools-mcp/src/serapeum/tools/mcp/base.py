...
from serapeum.core.tools.tool_spec.base import BaseToolSpec
from serapeum.core.tools.models import ToolMetadata
from serapeum.tools.mcp.tool_spec_mixins import (
    TypeResolutionMixin,
    TypeCreationMixin,
...
class McpToolSpec(
    ...
    async def to_tool_list_async(self) -> List[CallableTool]:
        """
        ...
        function_tool_list: List[CallableTool] = []
        for tool in tools_list:
            ...
            metadata = ToolMetadata(
                ...
                tool_schema=model_schema,
            )
            function_tool = CallableTool.from_function(
                func=fn, tool_metadata=metadata
            )
    ...
    def to_tool_list(self) -> List[CallableTool]:
        """
        Synchronous interface: Convert MCP Client tools to CallableTool objects.
        ...
        Returns:
            A list of CallableTool objects.
